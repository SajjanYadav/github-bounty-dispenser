...
function BountyIssuesSection({setIssues, issues, setLoading, setTotalBountyAmount} : 
  ...
  // //         try {
  // //           const response = await axios.get(`https://api.github.com/repos/SajjanYadav/cryptit/issues/${issue.github_issue}`, {
  // //             headers: {
  // //               Authorization: `token ${session.accessToken}`,
  // //             },
  // //           });
  // //           issues[index].title = response.data.title;
  // //           issues[index].body = response.data.body;
